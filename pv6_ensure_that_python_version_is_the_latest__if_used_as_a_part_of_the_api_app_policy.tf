module "pv6_ensure_that_python_version_is_the_latest__if_used_as_a_part_of_the_api_app_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.client}-Ensure that 'Python version' is the latest, if used as a part of the API app"
  policy_definition_display_name = "${var.client}-Ensure that 'Python version' is the latest, if used as a part of the API app"
