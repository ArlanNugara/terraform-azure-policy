module "latest_tls_version_should_be_used_in_your_function_app_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.org_prefix}Latest TLS version should be used in your Function App"
  ...
  policy_definition_rule = jsonencode(
    {
      ...
      "then" : {
        "effect" : "${var.latest_tls_version_should_be_used_in_your_function_app_policy_effect}",
        "details" : {
