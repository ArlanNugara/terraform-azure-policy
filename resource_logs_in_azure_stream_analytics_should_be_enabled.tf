module "resource_logs_in_azure_stream_analytics_should_be_enabled_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.org_prefix}Resource logs in Azure Stream Analytics should be enabled"
  ...
  policy_definition_rule = jsonencode(
    {
      ...
      "then" : {
        "effect" : "${var.resource_logs_in_azure_stream_analytics_should_be_enabled_policy_effect}",
        "details" : {
