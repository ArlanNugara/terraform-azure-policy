module "ftps_should_be_required_in_your_web_app_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.org_prefix}FTPS should be required in your Web App"
  ...
  policy_definition_rule = jsonencode(
    {
      ...
      "then" : {
        "effect" : "${var.ftps_should_be_required_in_your_web_app_policy_effect}",
        "details" : {
