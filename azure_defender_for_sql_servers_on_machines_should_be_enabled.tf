module "azure_defender_for_sql_servers_on_machines_should_be_enabled_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.org_prefix}Azure Defender for SQL servers on machines should be enabled"
  ...
  policy_definition_rule = jsonencode(
    {
      ...
      "then" : {
        "effect" : "${var.azure_defender_for_sql_servers_on_machines_should_be_enabled_policy_effect}",
        "details" : {
