module "resource_logs_in_logic_apps_should_be_enabled_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.org_prefix}Resource logs in Logic Apps should be enabled"
  ...
  policy_definition_rule = jsonencode(
    {
      ...
      "then" : {
        "effect" : "${var.resource_logs_in_logic_apps_should_be_enabled_policy_effect}",
        "details" : {
