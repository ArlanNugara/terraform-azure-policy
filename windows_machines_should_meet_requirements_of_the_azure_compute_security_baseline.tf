module "windows_machines_should_meet_requirements_of_the_azure_compute_security_baseline_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.org_prefix}Windows machines should meet requirements of the Azure compute security baseline"
  ...
  policy_definition_rule = jsonencode(
    {
      ...
      "then" : {
        "effect" : "${var.windows_machines_should_meet_requirements_of_the_azure_compute_security_baseline_policy_effect}",
        "details" : {
