module "im6_authentication_to_linux_machines_should_require_ssh_keys_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.client}-Authentication to Linux machines should require SSH keys"
  policy_definition_display_name = "${var.client}-Authentication to Linux machines should require SSH keys"
