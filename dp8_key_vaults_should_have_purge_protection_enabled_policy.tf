module "dp8_key_vaults_should_have_purge_protection_enabled_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.client}-Key vaults should have purge protection enabled"
  policy_definition_display_name = "${var.client}-Key vaults should have purge protection enabled"
