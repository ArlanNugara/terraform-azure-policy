  ...
  policy_definition_rule = jsonencode(
    {
      ...
      "then" : {
        "effect" : "${var.network_watcher_should_be_enabled_policy_effect}",
        "details" : {
