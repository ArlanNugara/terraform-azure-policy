module "pv4_guest_attestation_extension_should_be_installed_on_supported_linux_virtual_machines_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.client}-Guest Attestation extension should be installed on supported Linux virtual machines"
  policy_definition_display_name = "${var.client}-Guest Attestation extension should be installed on supported Linux virtual machines"
