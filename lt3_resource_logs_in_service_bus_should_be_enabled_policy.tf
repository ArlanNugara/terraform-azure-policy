module "lt3_resource_logs_in_service_bus_should_be_enabled_policy" {
  source                         = "./modules/generic_policy_module"
  policy_definition_name         = "${var.client}-Resource logs in Service Bus should be enabled"
  policy_definition_display_name = "${var.client}-Resource logs in Service Bus should be enabled"
